...
public class BitcoinKit: AbstractKit {
    ...
    weak var delegate: BitcoinCoreDelegate? {
        didSet {
            bitcoinCore.delegate = delegate
        }
    }
    
    init(withPubKey pubKey: Data, bip: Bip, walletId: String, syncMode: BitcoinCore.SyncMode = .api, networkParams: INetwork, confirmationsThreshold: Int = 6, logger: Logger?) throws {
