...
public class BitcoinCore {
    ...
    private let syncManager: SyncManager! = nil //todo delete
    ...
    public let peerGroup: IPeerGroup! = nil //todo delete
    public let initialBlockDownload: IInitialBlockDownload! = nil  //todo delete
    ...
    init(storage: IStorage, cache: OutputsCache, dataProvider: IDataProvider,
          bloomFilterLoader: BloomFilterLoader, transactionSyncer: ITransactionSyncer,
        ...
        pluginManager: IPluginManager, watchedTransactionManager: IWatchedTransactionManager, bip: Bip,
         peerManager: IPeerManager, unspentOutputsSetter: IUnspentOutputsSetter, transactionSizeCalculator: ITransactionSizeCalculator) {
