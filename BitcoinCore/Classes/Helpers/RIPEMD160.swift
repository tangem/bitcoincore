...
extension _RIPEMD160 {
    ...
    static func hash(message: String) -> Data {
        return _RIPEMD160.hash(message: message.data(using: .utf8)!)
    }
}
...
extension _RIPEMD160 {
    ...
    static func hmac(key: Data, message: String) -> Data {
        return _RIPEMD160.hmac(key: key, message: message.data(using: .utf8)!)
    }
    
    static func hmac(key: String, message: String) -> Data {
        return _RIPEMD160.hmac(key: key.data(using: .utf8)!, message: message)
    }
}
